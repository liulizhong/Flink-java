package com.xuexi.zijie.aggreagte.完成_state;
...
.socketTextStream("hadoop102", 7777)
    ...
    public static class MyCountMapFunction2 implements MapFunction<String, Long>, CheckpointedFunction {
