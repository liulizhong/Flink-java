...
public class NFAExample {
    public static void main(String[] args) throws Exception {
        ...
        KeyedStream<完成_LoginEvent, String> stream = env.fromElements(
    ...
    public static class StateMachineMapper extends RichFlatMapFunction<完成_LoginEvent, String> {
        ...
        @Override
        public void flatMap(完成_LoginEvent event, Collector<String> out) throws Exception {
            // 获取状态，如果状态为空，置为初始状态
